    ...
    <div class="right grid w-2/3 py-15 px-8 grid-cols-4 text-left bg-light-200 dark:bg-black">
      ...
      <div class="news col-span-2">
        ...
        <div class="product-store find-on py-4 flex justify-start gap-3">
          <a href="https://apps.apple.com/vn/app/id959841449"><img src="/img/icon/apple.png" alt=""></a>
          <a href="https://play.google.com/store/apps/details?id=com.shopee.vn&referrer=af_tranid%3Drsx9V4J79OX3NH5LwyqLcw%26pid%3DOrganicA%26c%3Dlp_home_and1"><img src="/img/icon/play.png" alt=""></a>
        </div>
      </div>
      <div class="payment">
