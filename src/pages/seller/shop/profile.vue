...
<template>
  <div class="shop-profile-container w-full px-24 py-2">
    <div class="bg-white grid shadow-sm shadow-gray-500/50 rounded-md divide-1 divide-solid divide-y divide-light-800">
