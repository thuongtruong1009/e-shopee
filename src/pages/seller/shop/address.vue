...
<template>
  <div class="shop-address-container w-full px-10 py-2 flex justify-center">
    <div class="bg-white shadow-sm shadow-gray-500/50 rounded-md divide-1 divide-solid divide-y divide-light-800 w-276">
